...
<html>
<head>
	<title>关联明细指标添加</title>
	<reps:theme />
</head>
<body>
<reps:container layout="true">
	<reps:panel id="first" dock="top" action="addetailsindicator.mvc?indicatorId=${indicatorId }" formId="form" validForm="true" method="post" style="width:800px">
			<reps:formcontent>
				
				<reps:formfield label="明细指标ID" fullRow="true">
					<reps:input name="detailIndicId" maxLength="30" required="true"></reps:input>
				</reps:formfield>
