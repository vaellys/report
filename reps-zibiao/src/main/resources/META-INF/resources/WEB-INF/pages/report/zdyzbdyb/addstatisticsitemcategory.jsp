...
<html>
<head>
	<title>统计项目分类添加</title>
	<reps:theme />
</head>
<body>
<reps:container layout="true">
	<reps:panel id="first" dock="top" action="addstatisticsitemcategory.mvc?indicatorId=${indicatorId }" formId="form" validForm="true" method="post" style="width:800px">
			<reps:formcontent>
				
				<reps:formfield label="统计项目分类ID" fullRow="true">
					<reps:input name="itemId" maxLength="30" required="true"></reps:input>
				</reps:formfield>
				
				<reps:formfield label="统计项目分类名称" fullRow="true">
					<reps:input name="itemName" maxLength="30" required="true"></reps:input>
				</reps:formfield>
