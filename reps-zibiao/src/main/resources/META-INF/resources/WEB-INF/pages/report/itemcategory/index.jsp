...
<body onload="load()">
	<reps:container layout="true">
		<reps:panel id="myleft" dock="left" title="指标分类" border="true" style="width:200px;overflow-y:scroll;overflow-x:auto;">
			<reps:tree id="mytree" items="${treelist}" var="li" cssClass="treeFolder" checkbox="false" expand="true">
				<reps:treenode parentKey="${li.parentId}" key="${li.id}">
					<a href="javascript:void(0);"
						onclick="showChilds(this, '${li.id}', '${li.isItem}')" id="${li.id}">${li.name}</a>
				</reps:treenode>
			</reps:tree>
		</reps:panel>
